...
internal fun <T : MemberDeclaration> T.reintroduceUIDs(): T {
    return when (this) {
        is FunctionDeclaration -> this.reintroduceUIDs() as T
        is ObjectLiteralDeclaration -> this.reintroduceUIDs() as T
        else -> this
    }
}
