// [test] functionAndSecondaryWithTrait.module_resolved_name.kt
...
// ------------------------------------------------------------------------------------------
// [test] functionAndSecondaryWithTrait.fibers.module_resolved_name.kt
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package fibers
...
// ------------------------------------------------------------------------------------------
// [test] functionAndSecondaryWithTrait.fibers.Fiber.module_resolved_name.kt
