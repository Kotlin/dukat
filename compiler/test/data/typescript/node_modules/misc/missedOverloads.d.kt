// [test] missedOverloads.module_resolved_name.kt
...
external interface JQueryStatic {
    ...
    fun get(url: String, success: () -> Any = definedExternally): MyXHR
    fun get(url: String, data: Any = definedExternally, success: () -> Any = definedExternally, dataType: String = definedExternally): MyXHR
    fun get(url: String, data: Any = definedExternally): MyXHR
    fun get(url: String, data: Any = definedExternally, success: () -> Any = definedExternally): MyXHR
    fun get(url: String, data: String = definedExternally, success: () -> Any = definedExternally, dataType: String = definedExternally): MyXHR
    fun get(url: String, data: String = definedExternally): MyXHR
    fun get(url: String, data: String = definedExternally, success: () -> Any = definedExternally): MyXHR
    ...
    fun fadeTo(duration: String, opacity: Number, easing: String = definedExternally): MyQuery
    fun fadeTo(duration: Number, opacity: Number, easing: String = definedExternally, complete: Function<*> = definedExternally): MyQuery
    fun fadeTo(duration: Number, opacity: Number, easing: String = definedExternally): MyQuery
}
...
external open class JJ {
    ...
    open fun hide(duration: Number = definedExternally): MyQuery
    open fun hide(duration: String = definedExternally, complete: Function<*> = definedExternally): MyQuery
    open fun hide(duration: String = definedExternally): MyQuery
    ...
    open fun hide(duration: Number = definedExternally, easing: String = definedExternally): MyQuery
    ...
    open fun hide(duration: String = definedExternally, easing: String = definedExternally): MyQuery
...
external fun hide(duration: Number = definedExternally): MyQuery

external fun hide(duration: String = definedExternally, complete: Function<*> = definedExternally): MyQuery

external fun hide(duration: String = definedExternally): MyQuery
...
external fun hide(duration: Number = definedExternally, easing: String = definedExternally): MyQuery
...
external fun hide(duration: String = definedExternally, easing: String = definedExternally): MyQuery
