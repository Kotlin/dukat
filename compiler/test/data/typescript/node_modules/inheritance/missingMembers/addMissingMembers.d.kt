// [test] addMissingMembers.module_resolved_name.kt
...
open external class MyStreamWritable : MyWritableStream {
...
open external class MyAbstractWritableStream {
    open fun ping(id: Any)
}

open external class MyAbstractStreamWritable : MyAbstractWritableStream