...
type BastaEvents = 'end' | 'finish' | 'basta' | 'finita';
...
declare class Message {
  ...
  once(event: BastaEvents, listener: () => void): this;
}
...
declare function addListener(event: Offline, listener: (worker: Pong) => void): Message;
