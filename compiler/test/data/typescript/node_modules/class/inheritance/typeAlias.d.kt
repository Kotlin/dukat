// [test] typeAlias.module_resolved_name.kt
...
open external class MultithreadedProcessor : AliasedProcessor {
    override fun process(input: Array<Number>): Array<Numba>
}

open external class SinglethreadedProcessor : AliasedProcessor {
